...
# Ciclo de vida: inicializa dependencias al arrancar y cierra el proceso activo al apagar
@asynccontextmanager
...
# Fabrica la app FastAPI con rutas, estaticos y lifespan configurados
