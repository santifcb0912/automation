...
class InConcertAuth:
    ...
    # Inyeccion de dependencias: recibe la pestana de Chromium donde se ejecutara el login
    def __init__(self, page: Page):
        self.page = page

    # Login: verifica sesion activa → si no, llena credenciales → click Ingresar → confirma
    ...
    # Verifica si ya hay sesion activa buscando elementos del DOM del login exitoso
    ...
    # Busca el campo usuario por input[name='userId'] (o email/username/placeholder) y lo llena
    ...
    # Busca el campo password por input[type='password'] (o name/id/placeholder) y lo llena
