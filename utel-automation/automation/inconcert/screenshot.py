...
class ScreenshotManager:
    # Sube screenshots a Google Drive sin carpeta (raíz). Retorna link público.


    # Conecta con Google Drive usando Service Account u OAuth. Propaga excepción si falla.
    def __init__(self):
    ...
    # Toma screenshot en RAM, sube a Drive raíz (sin carpeta) y retorna link público o None.
    ...
    # Reintenta subida a Drive hasta N veces con reconexión entre intentos. Retorna link o None.
    ...
    # Sube bytes a la raíz de Drive (sin carpeta), hace público el archivo y retorna link.
    ...
    # Otorga permiso público al archivo subido (anyone con link puede verlo).
